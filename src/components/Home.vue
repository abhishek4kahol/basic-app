              ...
              <p class="control">
                <div class="navbar-item has-dropdown is-hoverable">
                  ...
                  <div class="navbar-dropdown ">
                    ...
                    <div class="navbar-item">
                      <div class="button is-fullwidth is-small is-outlined is-danger" v-on:click="logout">
                        Sign Out
                      </div>
                    </div>
                  </div>
    ...
    <div class="hero-body">
      <div class="container">
        ...
        <a class="button icon is-small is-left has-text-warning is-outlined" style="display:block; margin-right:auto; height:229px; width: 41px; background-color: #F1ECE7; border-radius: 25px;">
          ...
          <a class="button icon is-small is-left has-text-warning is-outlined" style="display:block; margin-left:auto;height:229px; width: 41px; background-color: #F1ECE7; border-radius: 25px;">
